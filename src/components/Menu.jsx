              ...
              <ul class="treeview-menu">
                <li>
                  <a class="treeview-item" href="/usuario/listar">
                    <i class="icon fa fa-circle-o"></i>Usuario
                  </a>
                </li>
                <li>
                  <a class="treeview-item" href="/refeicao/listar'">
                    <i class="icon fa fa-circle-o"></i>Refeicao
                  </a>
                </li>
                <li>
                  <a class="treeview-item" href="/receita/listar">
                    <i class="icon fa fa-circle-o"></i>Receita
                  </a>
                </li>
                <li>
